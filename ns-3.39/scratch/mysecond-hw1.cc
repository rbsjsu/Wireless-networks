...
main(int argc, char* argv[])
{
    ...
    UdpEchoServerHelper echoServer2(8);
    ...
    UdpEchoClientHelper echoClient2(csmaInterfaces.GetAddress(nCsma), 8);
    ...
    ApplicationContainer clientApps = echoClient1.Install(p2pNodes.Get(0));
    clientApps.Add(echoClient2.Install(p2pNodes.Get(0)));
